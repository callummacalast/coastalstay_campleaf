<x-guest-layout>
    <section class=" text-gray-100">
        <div class="container flex flex-col-reverse mx-auto lg:flex-row">
            <div class="flex flex-col px-6 py-8 space-y-6 rounded-sm sm:p-8 lg:p-12 lg:w-1/2 xl:w-2/5 bg-sky-400 text-gray-900">
            ...
            <div class="lg:w-1/2 xl:w-3/5 ">
                <div class="flex items-center justify-center p-4 md:p-8 lg:p-12">
                    <img src="https://www.coastalstay.co.uk/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Ffarm.068326e6.png&w=1200&q=75" alt="" class="rounded-lg shadow-lg bg-gray-500 aspect-video sm:min-h-96">
                </div>
            </div>
        </div>
    </section>
